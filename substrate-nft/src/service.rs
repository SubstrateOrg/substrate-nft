...
use futures::prelude::*;
use substrate_nft_runtime::{self, GenesisConfig, opaque::Block, RuntimeApi};
...
native_executor_instance!(
	pub Executor,
	substrate_nft_runtime::api::dispatch,
	substrate_nft_runtime::native_version
);
...
macro_rules! new_full_start {
	($config:expr) => {{
		...
		let builder = substrate_service::ServiceBuilder::new_full::<
			substrate_nft_runtime::opaque::Block, substrate_nft_runtime::RuntimeApi, crate::service::Executor
		>($config)?
			...
			.with_import_queue(|_config, client, mut select_chain, transaction_pool| {
				...
				let (block_import, link_half) =
					grandpa::block_import::<_, _, _, substrate_nft_runtime::RuntimeApi, _, _>(
